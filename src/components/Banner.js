            ...
            <Row className='align-items-center'>
                <Col xs={12} md={6} xl={7}>
                  ...
                  <div classsName={isVisible ? "animate__animated animate__fadeIn" : ""}>
                    ...
                    <p>I am a dedicated Frontend Developer specializing in crafting visually captivating, responsive and functional web applications. With a passion for design and a commitment to innovation, I aim to exceed user expectations through collaborative and cutting-edge solutions.</p>
